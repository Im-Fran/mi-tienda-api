...
- 1012 nodes · 2009 edges · 57 communities (52 shown, 5 thin omitted)
...
Cohesion: 0.06
Nodes (58): MAGIC_LINK_SUBJECTS, CART_STATUSES, cartItems, carts, categories, AddressSnapshot, BankTransferInfo, createdAt() (+50 more)

### Community 2 - "Crypto & Utility Layer"

Cohesion: 0.08
Nodes (50): uuid(), badRequest(), conflict(), forbidden(), optionalCustomerMiddleware, cartRouter, productCategories, couponCategories (+42 more)

### Community 3 - "Auth Libraries & Email"

Cohesion: 0.07
Nodes (54): base64UrlEncode(), randomToken(), sha256Hex(), slugify(), magicLinkTemplate(), sendMagicLinkEmail(), sendViaResend(), fail() (+46 more)
...
Cohesion: 0.19
Nodes (14): rolePermissions, SYSTEM_ROLE_NAMES, systemPermissions, systemRoles, USER_PROVIDERS, userSystemRoles, assignPermissionToRole(), assignUserRoles() (+6 more)

### Community 6 - "Documentation & API Overview"

Cohesion: 0.18
Nodes (18): Magic Link Authentication, OAuth 2.0 Authentication, Cart (Authenticated and Guest), Cloudflare R2, Cloudflare Workers, Guest Checkout, Magic Link Authentication, Mi Tienda API (+10 more)
...
Cohesion: 0.13
Nodes (14): notFound(), shippingMethods, removePermissionFromRole(), addAddress(), deleteAddress(), getCustomer(), getStoreCustomer(), unsetDefaultAddresses() (+6 more)
...
Cohesion: 0.19
Nodes (16): coupons, productVariants, users, guestCartWith(), freshStore(), api(), ApiOptions, authCustomer() (+8 more)
...
Cohesion: 0.19
Nodes (12): createDb(), Database, dbMiddleware, orderItems, dateConds(), ordersByStatus(), PAID_SQL, REVENUE_SQL (+4 more)
...
- **476 isolated node(s):** `statusSchema`, `REVENUE_SQL`, `PAID_SQL`, `PreToolUse`, `allow` (+471 more)
...
- **Why does `columns` connect `Logo R2 Key Column Snapshot` to `Description Column Snapshot`, `Is Active Column Snapshot`, `User Roles DB Snapshot`, `Stores DB Snapshot`, `Updated At Column Snapshot`, `ID Column Snapshot`, `Migration Snapshot Root`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `statusSchema`, `REVENUE_SQL`, `PAID_SQL` to the rest of the system?**
